...
class Blob:
    ...
    def move(self, x=False, y=False):
        # Nếu không có x, y cho ngẫu nhiên
        if not x:
...
class ModifiedTensorBoard(TensorBoard):
    ...
    def set_model(self, model):
        self.model = model
        self._train_dir = os.path.join('../log_dir', 'train')
        self._train_step = self.model._train_counter
        self._val_dir = os.path.join('../log_dir', 'validation')
